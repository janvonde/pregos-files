...
<?php
	foreach ($result as $file) {
		echo "                  <tr>
                    <td> 
                      <i class=\"fa " . getFaIcon($file['filename']) . "\" style=\"display:table-cell;\"></i> 
                      <a style=\"display:table-cell;\" href=\"" . dirname(curPageUrl()) . "/" . $file['randname'] . "\" target=\"_blank\">" . $file['filename'] . "</a> 
                      <span style=\"display:table-cell; color:#bbb; padding-left:5px;\"> (" . human_filesize(filesize($conf['datadir'] . "/" . $file['randname'])) . ")</span>";
